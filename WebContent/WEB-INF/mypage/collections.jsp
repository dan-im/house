...
<b class="bordname" style="margin: 10px; cursor: pointer; color: #35C5F0;">모두</b>
<b class="bordname" style="margin: 10px; cursor: pointer;">사진</b>
<b class="bordname" style="margin: 10px; cursor: pointer;">노하우</b>
